  ...
  return (
    <div className="admin-page">
      <header className="page-header">
        ...
        <div className="dashboard-actions"><Link className="secondary-button" href="/school/finance/reports">Laporan</Link><Link className="primary-button" href="/school/finance/bulk">Invoice Massal</Link></div>
      </header>
